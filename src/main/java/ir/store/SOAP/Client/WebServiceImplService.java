 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://Server.SOAP.store.ir/", wsdlLocation = "http://localhost:8181/recieveLog?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://Server.SOAP.store.ir/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8181/recieveLog?wsdl");
    ...
    public WebServiceInterface getWebServiceImplPort() {
        return super.getPort(new QName("http://Server.SOAP.store.ir/", "WebServiceImplPort"), WebServiceInterface.class);
    }
    ...
    public WebServiceInterface getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Server.SOAP.store.ir/", "WebServiceImplPort"), WebServiceInterface.class, features);
    }
